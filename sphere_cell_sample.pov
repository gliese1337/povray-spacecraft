...
object { Sphere_Cell(1,Hull_T,Anchor_T) rotate 15*x rotate 15*y translate <-6, 0, 0> } 
object { Raspberry(Sphere_Cell(1,Hull_T,Anchor_T),1) rotate 15*x rotate 15*y }
object { Sphere_Cell(3,Hull_T,Anchor_T) rotate 15*x rotate 15*y translate <10, 0, 0>  }