...
camera {
   ...
   //location <-50,0,0>
   look_at <52,5,0>		// simple command for camera direction
}
...
#declare cable=
union{
cylinder{<0,71.15,1>,<60,4.15,0>,.1
        texture {pigment{Silver}}
	finish{ambient .45 phong 1}
	rotate -120*x
	}
cylinder{<0,68.85,-1>,<60,3.35,0>,.1
        texture {pigment{Silver}}
	finish{ambient .45 phong 1}
	rotate -120*x
	}
...
#declare winch1=
union{
polygon{5,<-sr,0,-4*sr/5>,<-sr,0,4*sr/5>,<0,3*sr/2,4*sr/5>,<0,3*sr/2,-4*sr/5>,<-sr,0,-4*sr/5>
	texture {pigment{Grey}}
	finish{ambient .45 phong 1}
	}
polygon{4,<-sr,0,-4*sr/5>,<0,3*sr/2,-4*sr/5>,<0,0,-4*sr/5>,<-sr,0,-4*sr/5>
	texture {pigment{Grey}}
	finish{ambient .45 phong 1}
	}
polygon{4,<-sr,0,4*sr/5>,<0,3*sr/2,4*sr/5>,<0,0,4*sr/5>,<-sr,0,4*sr/5>
...
cylinder{<2.8,2.9,-2.4>,<2.8,2.9,-2.15>,3.2
	texture {pigment{Grey}}
	finish{ambient .45 phong 1}
	}
cylinder{<2.8,2.9,2.4>,<2.8,2.9,2.15>,3.2
...
cylinder{<2.5,4,-2.3>,<2.5,4,2.3>,.5
	texture {pigment{Silver}}
	finish{ambient .45 phong 1}
	}
#declare wrap=
...
object{winch1 translate <-9.5,0,0>}
object{winch2 translate <14.2,0,0>}
object{winch3 translate <18.2,0,0>}
...
#declare winchcable=
union{
cylinder{<-8,-1,-1.6>,<((-57)*cos(radians(ang))-(64-70)*sin(radians(ang))),((64-70)*cos(radians(ang))+(-57)*sin(radians(ang)))+70,-8>,.15
texture {pigment{Grey}}
	finish{ambient .6}}
cylinder{<-8,-1,1.6>,<((-57)*cos(radians(ang))-(64-70)*sin(radians(ang))),((64-70)*cos(radians(ang))+(-57)*sin(radians(ang)))+70,8>,.15
texture {pigment{Grey}}
	finish{ambient .6}}
cylinder{<17.7,2,-2.25>,<((-33)*cos(radians(ang))-(66-70)*sin(radians(ang))),((66-70)*cos(radians(ang))+(-33)*sin(radians(ang)))+70,-2.6>,.15
texture {pigment{Grey}}
	finish{ambient .6}}
cylinder{<17.7,2,2.25>,<((-33)*cos(radians(ang))-(66-70)*sin(radians(ang))),((66-70)*cos(radians(ang))+(-33)*sin(radians(ang)))+70,2.6>,.15
texture {pigment{Grey}}
...
object{carsect translate 66*x}
object{crewsect translate 93*x}
object{habsect translate 65*x}
