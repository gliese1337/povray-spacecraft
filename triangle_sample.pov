...
camera {  
  orthographic
  location -7*vnormalize(<1, 0, 0>)
  angle 0 // direction 2*z 
  right     x*image_width/image_height // keep proportions with any aspect ratio
  look_at   0
}

light_source { -1*<140,200, 300> rgb <1.0, 1.0, 0.95>*1.5 }
light_source { -1*< 140,200,-300> rgb <0.9, 0.9, 1.00>*0.9 shadowless }

#declare Hull_T = texture { pigment { Copper } }
#declare Anchor_T = texture { pigment { Silver } }

object { Triangle(Sphere_Cell(Hull_T, Anchor_T),1) }