...
object { Cone_Cell(1,Hull_T,Anchor_T) rotate 15*x rotate 15*y translate <-4.5*Module_Radius, 0, 0> } 
object { Raspberry(Cone_Cell(1,Hull_T,Anchor_T),1) rotate 15*x rotate 15*y }
object { Cone_Cell(3,Hull_T,Anchor_T) rotate 15*x rotate 15*y translate <7*Module_Radius, 0, 0>  }